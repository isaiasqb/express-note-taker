...
The application’s front end has already been created. The challange was to work on the back end and connect it to the front end and deploy the app using Heroku.
